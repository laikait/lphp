...
| Reading configuration and scanning module directories were the largest remaining costs of a boot | `cache:warm` replaces both with one opcache-held file each. [The production boot path](../operations/deployment.md#the-production-boot-path) |
